...
With tracking, moving patterns are easily captured, thereby it provides additional information to capture motion more exactly.
This approach has demonstrated the effectiveness in studies \cite{matikainen2009trajectons, messing2009activity, sun2009hierarchical} which concentrate on exploiting trajectories in video.
In our best knowledge, there is no related work which extends to depth video.
